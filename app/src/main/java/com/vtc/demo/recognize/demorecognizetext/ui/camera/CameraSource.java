        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    Logger.Log("Frame processing thread interrupted on release.");
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Logger.Log("Failed to clear camera preview: " + e.getMessage());
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    public int doZoom(float scale) {
        synchronized (mCameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                Logger.Log("Zoom is not supported on this device");
                return currentZoom;
            }
    ...
    public void takePicture(ShutterCallback shutter, PictureCallback jpeg) {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                ...
                mCamera.takePicture(startCallback, null, doneCallback);
            }
        }
    }
...
//        parameters.setPreviewSize(200, 50);
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Logger.Log("Camera focus mode: " + mFocusMode +
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                Logger.Log("Camera flash mode: " + mFlashMode +
                        " is not supported on this device.");
            }
        }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            Logger.Log("No preview sizes have a corresponding same-aspect-ratio picture size");
            for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                Logger.Log("Bad rotation value: " + rotation);
        }
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (mLock) {
                ...
                if (!mBytesToByteBuffer.containsKey(data)) {
                    Logger.Log("Skipping frame.  Could not find ByteBuffer associated with the image " +
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            Logger.Log("Frame processing loop terminated." + e.getMessage());
                            return;
                        }
                    }
                ...
                try {
                    ...
                    Logger.Log("Exception thrown from receiver." + t.getMessage());
                } finally {
